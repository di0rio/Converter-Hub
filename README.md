...
source for the on-disk structure. Firebird 2.0, 2.1 and 2.5 (ODS 11), Firebird
3 (ODS 12) and Firebird 4 and 5 (ODS 13) files are read; any other version is
refused with its version named. Only
